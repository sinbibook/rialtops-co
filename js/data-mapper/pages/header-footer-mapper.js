(function (global) {
  ...
  // MAPPER: businessInfo.businessName / businessAddress / businessNumber / representativeName
  //         (전화번호는 footer.html 하드코딩으로 대체, 매핑 주석 처리)
  HeaderFooterMapper.prototype.mapFooter = function () {
    ...
    // 전화번호 : footer.html 에 하드코딩(070-4364-9309) 처리하여 매핑 해제
